...
- [x] 50. 선택정렬 ●
- [x] 51. 버블정렬 ●
- [x] 52. Special Sort(버블정렬응용) ●
- [x] 53. 삽입정렬 ●
- [x] 54. LRU(카카오 캐시 변형 : 삽입정렬응용) ●
- [x] 55. 장난꾸러기 현수 ●
- [x] 56. 좌표 정렬 ●
- [x] 57. 회의실 배정 ●
- [x] 58. 결혼식 ●
...
- [x] 62. 재귀함수와 스택프레임(중요) ●
- [x] 63. 이진수 출력(재귀) ●
- [x] 64. 이진트리순회(DFS: 깊이우선탐색) ●
- [x] 65. 부분집합 구하기(이진트리 DFS) ●
- [x] 66. 합이 같은 부분집합(이진트리 DFS) ●
- [x] 67. 바둑이 승차(이진트리 DFS)
- [x] 68. 최대점수 구하기(이진트리 DFS)
- [x] 69. 중복순열(다중 for문과 재귀의 차이점) ●
- [x] 70. 동전교환(DFS-Cut Edge Tech) ●
- [x] 71. 순열 구하기 ●
- [x] 72. 팩토리얼 ●
- [x] 73. 조합수(메모이제이션) ●
- [x] 74. 수열 추측하기(순열, 이항계수 응용) ●
- [x] 75. 조합 구하기(중요) ●
- [x] 76. 수들의 조합 ●
...
- [x] 78. 경로탐색(DFS-인접행렬 : 노드개수가 적을 때) ●
- [x] 79. 경로탐색(DFS-인접리스트 : 노드개수가 많을 때 적용) ●
- [x] 80. 미로탐색 ●
- [x] 81. 이진트리 넓이우선탐색(BFS) ●
- [x] 82. 송아지 찾기(BFS) ●
- [x] 83. 섬나라 아일랜드(DFS) ●
- [x] 84. 섬나라 아일랜드(BFS : 넓이우선탐색) ●
